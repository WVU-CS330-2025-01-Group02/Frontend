...
document.addEventListener("DOMContentLoaded", function() {
  ...
  // fix the dumbass GET/ errors when using wrong addresses that wont convert to lat/long for some reason
  // ------------------------------------------------ 
...
function hideLoading() {
  ...
  if (loadingOverlay) {
    loadingOverlay.style.display = 'none';
      ...
      // TEMPORARY: adding a dookie search functionality that still kinda works
      ...
      // TEMP: adding a shitty ai oded geolocation button functionality
